...
/**
 * Метод Дорманда-Принса 8-го порядка.
 * Метод очень высокого порядка точности для сверхточных вычислений.
 * c = [1/18, 1/12, 1/8, 5/16, 3/8, 59/400, 93/200, ...]
 * b = [14005451/335480064, 0.0, ...]
 * a = [1/18, 1/48, 1/16, ...]
 */
public class DormandPrince8 extends ButcherTableMethod {
   private static final double[] C = {
     ...
     */
    public DormandPrince8(RightCalculator calculator) {
